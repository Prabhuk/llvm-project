...
void AsmPrinter::emitCallGraphSection(const MachineFunction &MF,
  ...
  // known. 5) Number of indirect callsites. 6) For each indirect callsite, its
  // callsite PC and callee's expected type id. 7) Number of unique direct
  // callees. 8) For each unique direct callee, the callee's PC.
