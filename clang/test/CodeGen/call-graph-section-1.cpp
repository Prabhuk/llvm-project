...
void foo() {
  ...
  // CST: call noundef i32 %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFicfdE.generalized") ]
  (ObjCls2Ptr->*fp_f1)(0, 0, 0);

  // CST: call noundef ptr %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFPvS_S_S_E.generalized") ]
  (ObjCls2Ptr->*fp_f2)(0, 0, 0);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFv4Cls1E.generalized") ]
  (ObjCls2Ptr->*fp_f3)(Cls1Param);

  // CST: call void  %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFv4Cls1E.generalized") ]
  (ObjCls2Ptr->*fp_f4)(Cls1Param);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFvPvE.generalized") ]
  (ObjCls2Ptr->*fp_f5)(&Cls1Param);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFvPKvE.generalized") ]
  (ObjCls2Ptr->*fp_f6)(&Cls1Param);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFvR4Cls1E.generalized") ]
  (ObjCls2Ptr->*fp_f7)(Cls1Param);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSFvRK4Cls1E.generalized") ]
  (ObjCls2Ptr->*fp_f8)(Cls1Param);

  // CST: call void %{{.*}}(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}} [ "type"(metadata !"_ZTSKFvvE.generalized") ]
  (ObjCls2Ptr->*fp_f9)();
}
